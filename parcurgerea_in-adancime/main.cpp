...
int main() {
    ...
    cout << "Introduceți numărul de noduri și numărul de arce ale grafului: ";
    cin >> numar_noduri >> numar_arce;

    // Inițializarea listei de adiacență
    vector<vector<int>> graf(numar_noduri);

    cout << "Introduceți perechile de noduri care formează arcele:\n";
    ...
    int nod_start;
    cout << "Introduceți nodul de start pentru parcurgere: ";
    cin >> nod_start;
